...
class DishBowl extends StatefulWidget {
  final Map category;
  final bool update,large;
  ...
  const DishBowl({
    ...
    this.update,
    this.dishIndex,
    this.catIndex, this.large,
  }) : super(key: key);
  @override
  _DishBowlState createState() => _DishBowlState();
}

class _DishBowlState extends State<DishBowl> {
  ...
  TextEditingController nameController = TextEditingController(),
      ...
      bowlSizeController = TextEditingController(),
      countPerController = TextEditingController(),
      minmumItemController = TextEditingController(),
      itemPriceController = TextEditingController();
  final formPadding = EdgeInsets.symmetric(vertical: 8.0);
  bool _autoValidate = false,
      _autoValidateSheet = false,
      _btnEnabled = true,
      edit = false,large=false,
      isNetwork = true,
  ...
  var selectedExtras = [],
      ...
      selectedCategory = [],
      onlineMeals = [];
  int index = 0, cix, dix,costPerItem=0 ;
  String nameField,
      dishId,
      descField,
      packageField="0.0",
...
minmumItemField,
  ...
  var durationsList = [
    ...
    {'name': '1 Day', 'value': '10'},
    {'name': '2-3 Days', 'value': '20'},
    {'name': '5 Days', 'value': '30'},
    {'name': '1 Week', 'value': '45'},
    {'name': '1 - 2 Weeks', 'value': '60'},
    {'name': '2 Weeks', 'value': '75'},
    {'name': '2 - 3 Weeks', 'value': '90'},
    {'name': '1 Month', 'value': '105'},
  ];
  @override
  void initState() {
    ...
    if (widget.update) {
      ...
      switch(widget.category['dishes'][widget.dishIndex]['group']['type']){
        case "LARGE_SERVING":
          bowlSizeController.text=widget.category['dishes'][widget.dishIndex]['group']['bowl_size'].toString();
        break;
        case "SMALL_CHOPS":
          minmumItemController.text=widget.category['dishes'][widget.dishIndex]['group']['min_order_count'].toString();
          countPerController.text=widget.category['dishes'][widget.dishIndex]['group']['cost_per_item'].toString();
        break;
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          update ? 'Update Dish' : large? 'Create Large Dish':"Create Small Dish",
          ...
          child: ListView(
            children: [
              Padding(
                ...
                child: Text(
                  large?'Create and describe your dish for that can serve more person\'s and maybe takes longer to perpare' :'Create dishes like small chops, spring rolls and other dish that fits into this category  ',
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: Validation().oneNumberAllow,
                          onSaved: (String val) {
                            packageField = val;
                          },
                          decoration: FormDecorator(
            ...
            large? Padding(
                        ...
                        child: TextFormField(
                          keyboardType: TextInputType.number,
                          controller: bowlSizeController,
                          validator: _validation.oneNumber,
                          onSaved: (String val) {
                            bowlSizeField = val;
                          },
                          decoration: FormDecorator(
                              hint: 'Bowl Size', helper: 'e.g 2-liters, 3-liters'),
                        ),
                      ): Padding(
                padding: EdgeInsets.symmetric(vertical: 8.0),
                child: Row(
                  children: <Widget>[
                    Expanded(
                      child: Padding(
                        ...
                        child: TextFormField(
                          keyboardType: TextInputType.number,
                          controller: minmumItemController,
                          validator: _validation.oneNumber,
                          onChanged: (val){
                            getItemCost();
                          },
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: FormDecorator(
                              hint: 'Cost per item', helper: 'e.g N20'),
                        ),
                      ),
                    ),
                  ],
            ...
            Divider(),
             large?SizedBox():Text("Total cost for one item: N$costPerItem" ,style:TextStyle(fontSize:18 )),
             Divider(),
                           Padding(
        ...
        text: update ? 'Update Dish' : 'Save Dish',
              ...
              SizedBox(
               ...
               saveDish() async {
                 ...
                 Map group=large ? {
                     'type':'LARGE_SERVING' ,
                     'bowl_size': double.parse(bowlSizeField),
                   }: {
                     'type': 'SMALL_CHOPS',
                      'min_order_count': int.parse(minmumItemController.text),
                      'cost_per_item':int.parse(countPerController.text),
                   };
             ...
             //    isLoading();
               ...
               finishAction() async {
                 ...
                 if (update) {
                   ...
                   appBloc.dish[cix]['dishes'][dix]['price'] =
                       double.parse(priceField).toStringAsFixed(2);
               ...
               getItemCost() {
                 print('${countPerController.text} and ${ minmumItemController.text}');
                 if(countPerController.text!="" && minmumItemController.text!=""){
                   costPerItem=int.parse(countPerController.text)*int.parse(minmumItemController.text);
                 }else{
                   costPerItem = 0;
                 }
                 setState(() {});
